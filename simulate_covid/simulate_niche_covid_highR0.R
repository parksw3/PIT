...
# https://www.nature.com/articles/s41586-021-03470-x#Abs1
...
data_meijers_niche2 <- simulate_meijers_niche(R_1=R0*1.7,
																							T11=1,
																							T21=2.8,
																							tau1=5.5,
																							R_2=R0*1.7*1.5,
...
data_meijers_niche3 <- simulate_meijers_niche(R_1=R0*1.7*1.5,
																							T11=1,
																							T21=27,
																							tau1=3.5,
																							R_2=R0*1.7*1.5*1.5,
...
data_meijers_niche4 <- simulate_meijers_niche(R_1=R0*1.7*1.5*1.5,
																							T11=1,
																							T21=2.4,
																							tau1=3,
...
save("data_meijers_niche1", "data_meijers_niche2", "data_meijers_niche3",
		 "data_meijers_niche4",
		 file="simulate_niche_covid_highR0.rda")
